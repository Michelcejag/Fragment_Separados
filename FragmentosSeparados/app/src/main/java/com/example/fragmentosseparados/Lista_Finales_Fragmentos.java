...
public class Lista_Finales_Fragmentos extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState){
        View view = inflater.inflate(R.layout.lisa_animales_fragmento,container,false);

        RecyclerView recyclerView = view.findViewById(R.id.Recycler_lista_Animales);
            ...
            textView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(orientation== Configuration.ORIENTATION_PORTRAIT) {
                        ...
                        Intent intent = new Intent(context, Info_Animal_Activity.class);
